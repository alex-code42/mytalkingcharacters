        ...
        <>
            ...
            <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">"Well, howdy there, partner! I am one helluva wasted alien, I tell ya."</h2>
                    <p className="mb-4 text-white">Quote from the "Wasted Alien"</p>
